...
import 'Orders/OrdersPage.dart';  // Make sure to import the OrdersPage (or the screen to show orders)
...
ListTile(
  ...
  onTap: () {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const NotificationsManagement()),
    );
  },
),
